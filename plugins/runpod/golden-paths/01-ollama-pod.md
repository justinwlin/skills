...
reusable pod loop in [`../skills/runpod-usage/reference/pod-workflows.md`](../skills/runpod-usage/reference/pod-workflows.md).
...
| **runpodctl** installed | `curl -sSL https://cli.runpod.net \| bash` (see [`../skills/runpodctl/SKILL.md`](../skills/runpodctl/SKILL.md)). |
...
1. [`../skills/runpod-usage/reference/pod-workflows.md`](../skills/runpod-usage/reference/pod-workflows.md)
   — the reusable pod development loop (provision → ssh-exec → set up → run → poll
   readiness → escalate → deliver).
2. [`../skills/runpod-usage/reference/on-pod-setup.md`](../skills/runpod-usage/reference/on-pod-setup.md)
   — install hygiene (uv/apt, pin, non-interactive, cache on volume, background +
   log, detach long-lived servers).
3. [`../skills/runpod-usage/reference/storage.md`](../skills/runpod-usage/reference/storage.md)
